...
///////////////////////////  
Hello(String frameText)//constructor  
{  
super(frameText);  
...
{  
new Hello("Calculator - JavaTpoint");  
}  
}  
...
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, Hello clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, Hello clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(Hello.getFormattedText(tempd));}  
...
cl.displayLabel.setText(Hello.getFormattedText(temp));  
//cl.number=temp;  
}//actionPerformed  
}//class  
...
/////////////////////////////////  
MyMemoryButton(int x,int y, int width,int height,String cap, Hello clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
case 'R':   
    cl.displayLabel.setText(Hello.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, Hello clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
